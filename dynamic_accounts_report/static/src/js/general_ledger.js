...
class GeneralLedger extends owl.Component {
    setup() {
        ...
        console.log('account111:', this.state.account);
        console.log('Partner List:', this.state.selected_journal_list);
        console.log('Selected Partner:', this.state.account_data_list);
        console.log('Selected Partner Rec111:', this.state.journals);
    }
    async load_data() {
        let account_list = []
        let account_totals = ''
        ...
        try {
            ...
            console.log("==============================",self.state.account_data)
            for (const [key, value] of Object.entries(self.state.account_data )) {
