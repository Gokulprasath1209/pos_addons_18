    ...
    async load_data() {
        ...
        try {
            ...
            self.state.data = await self.orm.call("account.partner.ledger", "view_report", [[this.wizard_id], action_title,]);
             ...
             for (const [key, value] of Object.entries(self.state.data )) {
...
//            })
            ...
            console.log('---------------66666',self.state.data)
            console.log('Partner:', this.state.partners);
            console.log('Partner List:', this.state.partner_list);
            console.log('Selected Partner:', this.state.selected_partner);
            console.log('Selected Partner Rec:', this.state.selected_partner_rec);
        }
        catch (el) {
