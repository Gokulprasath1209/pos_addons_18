...
class AccountPartnerLedger(models.TransientModel):
    ...
    def view_report(self, option, tag):
        ...
        print("Unique Partner IDs:", all_partners)
        for partner in partner_ids:
            ...
            print("rrrrrrrrew1111111",move_line_id)
            move_line_list = []
            print("222222",move_line_list)
            ...
            print("rrrrrrrrrrrrrr",partner_dict[partner.name])
            ...
            # partners_filter_list['all_partners'] = all_partners
            # print("yyyyyyyyyyyyyyyyyyy",partners_filter_list)
            print("wwwwwwwwwwwwwwwwwww",partner_dict)
        return partner_dict
    ...
    def get_filter_values(self, partner_id, data_range, account, options):
        ...
        return partner_dict,partner_dict
